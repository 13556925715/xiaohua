    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox-content">
                <div class="row">
                    <form class="form-inline" id="searchForm" action="/checkGroup/list?qo.keyword=keyword" method="post">
                        ...
                        <div class="form-group">
                            <a href="/checkGroup/input" class="btn btn-success btn_redirect" data-url="adduser.html">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${pageResult.list}" var="entity" varStatus="entityStatus">
                            <tr>
                                ...
                                <td>
                                    <c:if test="${entity.groupSex == 1}">男</c:if>
                                    <c:if test="${entity.groupSex == 2}">女</c:if>
                                    <c:if test="${entity.groupSex == 3}">不限</c:if>
                                </td>
                                <td>
                                    <a class="btn btn-info btn-xs btn-input"
                                       href="/checkGroup/input?groupId=${entity.groupId}">
                                        <span class="glyphicon glyphicon-pencil"></span> 编辑
                                    </a>
                                    <a href="/checkGroup/delete?groupId=${entity.groupId}"
